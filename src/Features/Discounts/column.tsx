...
import type { Discount, DiscountDetails } from "./type";
...
import { EditDiscount } from "./EditDiscountColumn";
...
export const Columns: CustomColumnDef<Discount>[] = [
  {
    id: "expander",
    header: () => null,
    cell: ({ row }) => (
    ...
    expandedContent: ({ original }) => (
      <ExpandedRowContent discount={original} />
    ),
  },
  { header: "Discount Code", accessorKey: "discountName" },
  // { header: "Id", accessorKey: "id" },
  { header: "Discout On", accessorKey: "discountOn" },
  { header: "Discount Type", accessorKey: "valueType" },
  { header: "Discount Value", accessorKey: "value" },
  {
    header: "Start Date",
  ...
  },
  {
    ...
    header: "Edit",
    cell: ({ row }) => {
      return <EditDiscount discount={row.original} />;
    },
  },
];
...
const ExpandedRowContent: React.FC<ExpandedRowProps> = ({ discount }) => {
                    ...
                    <tr key={index}>
                      ...
                      <td className="border border-gray-300 px-4 py-2 ">
                        <div className="flex items-center">
                          ...
                          ></span>
                          <span>{detail.skuDetails.color?.split("-")[0]}</span>
                        </div>
                      </td>
                      <td className="border border-gray-300 px-4 py-2">
