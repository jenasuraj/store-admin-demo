  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-blue-900 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-teal-600/40 mix-blend-multiply" />
      </div>
      ...
      <div className="z-10 w-full max-w-[400px] bg-[#f2f2f2] shadow-2xl">
        ...
        <div className="bg-white py-4 text-center shadow-sm">
          ...
          <div className="mx-auto flex h-16 w-fit items-center justify-center">
            <h1 className="text-2xl font-bold text-teal-600">Actify Portal</h1>
          </div>
        </div>
        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  {...register("username")}
                  type="text"
                  className="w-full border border-gray-300 bg-white p-2 pl-3 text-sm focus:border-red-500 focus:outline-none"
                />
                <User className="absolute right-3 top-2.5 h-4 w-4 text-red-800" />
              </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 bg-white p-2 pl-3 text-sm focus:border-red-500 focus:outline-none"
                />
                <Lock className="absolute right-3 top-2.5 h-4 w-4 text-red-800" />
              </div>
            ...
            <button
              type="submit"
              className="mt-4 w-full bg-red-600 py-2.5 text-sm font-semibold text-white transition"
            >
...
export default AutoBotLoginPage;