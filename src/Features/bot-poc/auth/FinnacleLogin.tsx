...
const PennantLoginPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-sky-900 overflow-hidden">
      {/* Background Image with sky Overlay */}
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-sky-600/40 mix-blend-multiply" />
      </div>
      ...
      <div className="z-10 w-full max-w-[400px] bg-[#f2f2f2] shadow-2xl">
        ...
        <div className="bg-white py-8 text-center shadow-sm">
          ...
          <div className="mx-auto flex h-16 w-fit items-center justify-center">
            <h1 className="text-2xl font-bold text-sky-600">Welcome to Finacle</h1>
          </div>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  {...register("username")}
                  type="text"
                  className="w-full border border-gray-300 bg-white p-2 pl-3 text-sm focus:border-sky-500 focus:outline-none"
                />
                <User className="absolute right-3 top-2.5 h-4 w-4 text-sky-800" />
              </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 bg-white p-2 pl-3 text-sm focus:border-sky-500 focus:outline-none"
                />
                <Lock className="absolute right-3 top-2.5 h-4 w-4 text-sky-800" />
              </div>
