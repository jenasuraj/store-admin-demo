...
const BankLoginPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-yellow-600 overflow-hidden">
      ...
      <div className="z-10 w-full max-w-[400px] bg-[#f2f2f2] shadow-2xl">
        ...
        <div className="bg-white py-2 text-center shadow-sm">
          ...
          <div className="mx-auto flex h-16 w-fit items-center justify-center">
            <h1 className="text-2xl font-bold text-yellow-600">Bank Login</h1>
          </div>
        </div>
        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="submit"
              className="mt-4 w-full bg-orange-600 py-2.5 text-sm font-semibold text-white transition"
            >
