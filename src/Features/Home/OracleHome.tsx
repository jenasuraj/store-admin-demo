...
const OracleHomePage = () => {
  ...
  const handleExport = () => {
    ...
    const fileUrl = '/autobot/Oracle_Fusion_GL.xlsx'; 
    const link = document.createElement('a');
    link.href = fileUrl;
    link.setAttribute('download', 'oracle_data.csv'); // Force download
      ...
      <header className="sticky top-0 z-30 w-full border-b bg-white shadow-sm">
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-gray-900">Oracle Dashboard</span>
          </div>
