...
const FinacleHomePage = () => {
  ...
  const handleExport = () => {
    ...
    const fileUrl = '/autobot/Finacle_CBS.xlsx'; 
    const link = document.createElement('a');
    link.href = fileUrl;
    link.setAttribute('download', 'finacle_data.csv'); // Force download
      ...
      <header className="sticky top-0 z-30 w-full border-b bg-white shadow-sm">
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded bg-sky-400 text-white">
              <span className="font-bold">O</span>
            </div>
            <span className="text-lg font-semibold text-gray-900">Finacle Dashboard</span>
          </div>
...
export default FinacleHomePage;