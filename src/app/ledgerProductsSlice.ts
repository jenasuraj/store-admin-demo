...
// export type pageAbleObjectType = {
//   sort: sortObjectType;
//   pageNumber: number;
//   pageSize: number;
//   offset: number;
...
// export interface ledgerProductsDataType {
//   productId: number;
//   defaultSku: string;
//   name: string;
...
// export interface ledgerProductsData {
//   content: ledgerProductsDataType[];
//   pageable?: pageAbleObjectType;
//   totalPages?: number;
...
//   ledgerProducts: ledgerProductsData;
//   loading: boolean;
//   error: any;
// }
...
//     builder.addCase(fetchLedgerProducts.pending, (state, action) => {
//       state.loading = true;
//     });
//     builder.addCase(fetchLedgerProducts.fulfilled, (state, action) => {
//       state.loading = false;
//       state.ledgerProducts = action.payload;
//     });
