...
>(
  (
    ...
    const renderVirtualContent = useCallback(() => {
      ...
      return (
        <div
          className="relative w-full overscroll-contain z-[99999999999]"
          style={{
          ...
          {virtualizer.getVirtualItems().map((virtualItem: VirtualItem) => {
            ...
            return (
              <div
                ...
                style={itemStyle}
              >
                <div className="grid grid-cols-5 gap-2 w-full z-99999">
    ...
    return (
      ...
      >
        ...
        <PopoverContent className="w-64 p-2 z-99999">
          {searchable && (
            <Input
          ...
          {categorized && search.trim() === "" && (
            <div className="flex flex-row gap-1 mt-2 overflow-x-auto pb-2 z-99999">
              {categoryButtons}
            </div>
          )}
          <div
            ref={parentRef}
            className="max-h-60 overflow-auto z-99999"
