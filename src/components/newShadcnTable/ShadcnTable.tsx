                          ...
                          onClick={() => {
                            ...
                            if (api) {
                              ...
                              if (
                                ...
                                newSortDir = "desc"; // Ascending -> Descending
                              } else if (
                                currentSortBy === header.column.id &&
                                currentSortDir === "desc"
                              ) {
                                newSortDir = undefined; // Descending -> No Sort
                              } else {
                                newSortDir = "asc"; // No Sort -> Ascending
                              }

                              if (newSortDir) {
                                params.set("sortBy", header.column.id);
                        ...
                        >
                          ...
                          <div className="flex items-start gap-2">
                            {api ? (
                              ...
                              params.get("sortBy") === header.column.id ? (
                                <ChevronUp
