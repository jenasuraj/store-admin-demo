...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchDashboardStats = async () => {
      ...
      try {
        ...
        const ledgerPromise = axios.get(
          `${BASE_URL}/api/payments/ledger-stats?startDate=${startDate}&endDate=${endDate}`
        );
  ...
  }, [dispatch, user?.user.groupCompanyId, startDate, endDate]); // Added startDate and endDate as dependencies
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
            ...
            <div className="flex items-center gap-2 bg-white p-1 rounded-md border shadow-sm">
                <Input 
                    ...
                    className="border-0 h-8 w-[130px] text-xs focus-visible:ring-0"
                />
