...
// import { PriceList, getPriceLists, getCustomers, Customer } from '@/lib/storage';
...
//   const currentList = priceLists.find(l => l.id === selectedPriceListId);
...
//   const selectedProductsList = currentList?.products.filter(p =>
...
//                 Please create a price list first
//               </p>
//             </CardContent>
//           </Card>
//         ) : (
...
//             <div>
//               <Label className="text-base font-semibold mb-3 block">Select Price List</Label>
//               <div className="flex gap-2 flex-wrap">
//                 {priceLists.map(list => (
//                   <Button
//                     key={list.id}
//                     variant={selectedPriceListId === list.id ? 'default' : 'outline'}
//                     onClick={() => {
...
//                         </p>
//                         <p className="text-muted-foreground">
//                           Rate: <span className="font-semibold text-foreground">₹{product.price}</span>
//                         </p>
//                       </div>
//                     </CardContent>
//                   </Card>
